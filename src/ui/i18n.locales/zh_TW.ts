...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.mobs.gloomshade.name': '虛空行者',
  'entities.mobs.duskborn.name': '魅魔',
  'entities.mobs.grix_the_tunnelking.name': '隧道之王葛瑞克斯',
  'entities.mobs.spellhound.name': '地獄獵犬',
  'entities.mobs.warfiend.name': '惡魔守衛',
  'entities.mobs.pyre_colossus.name': '地獄火',
  'entities.mobs.wraithborn.name': '末日守衛',
  ...
  'guide.family.mudfin.name': '魚人',
  'guide.family.mudfin.desc': '兩棲的沼澤居民，成群聚集於淺灘，喧鬧且強烈護衛地盤。',
  'guide.family.burrower.name': '狗頭人',
  'guide.family.burrower.desc': '頭頂蠟燭的挖掘者，盤踞於礦坑與洞穴中，凶猛地守衛著礦石。',
  ...
  'entities.itemSets.soulflame.bonus3': '智力提高 15 點，精神提高 15 點。',
  'entities.itemSets.stormcallers.name': '喚雷者法衣',
  'entities.itemSets.stormcallers.bonus2': '你不會被擊退（擊退抗性 100%）。',
  'entities.itemSets.stormcallers.bonus3': '智力提高 15 點，精神提高 15 點。',
