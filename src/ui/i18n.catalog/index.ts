...
export const en = {
  ...
  classes: {
    ...
    warlock: 'Hexbinder',
    druid: 'Biomorph',
    warriorAria: 'Fighter class',
    paladinAria: 'Vanguard class',
    hunterAria: 'Scout class',
    rogueAria: 'Janitor class',
    priestAria: 'Medic class',
    shamanAria: 'Channeler class',
    mageAria: 'Arcanist class',
    warlockAria: 'Hexbinder class',
    druidAria: 'Biomorph class',
  },
  controls: {
