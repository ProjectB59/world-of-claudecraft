...
//
// `IWorld` (src/world_api.ts, 161 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (161 / 40 / 121)
...
// Partition: 40 `data` + 121 `method` (read-returning + command-void + async).
...
//   (4) their union, sorted, equals the pinned 161-name IWORLD_MEMBERS set (a member
